...
function renderSearchResults(results) {
  ...
  if (results.length > 0) {
    results.forEach(function(result) {
      // Create result item
      container.innerHTML += '<article class="mini-post"><a href="' + result.ref + '"><header><h2>' + resultDetails[result.ref].title + '</h2></header><main><p>' + resultDetails[result.ref].body.slice(0, 50) + " ..." + '</p></main></a></article>';
    });
